...
# manualAnnotation
write.xlsx2(mergedAnnotationCluster1Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.1", append = TRUE)
gc()
write.xlsx2(mergedAnnotationCluster2Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.2", append = TRUE)
gc()
write.xlsx2(mergedAnnotationCluster3Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.3", append = TRUE)
gc()
write.xlsx2(mergedAnnotationCluster4Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.4", append = TRUE)
gc()
write.xlsx2(mergedAnnotationCluster5Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.5", append = TRUE)
gc()
write.xlsx2(mergedAnnotationCluster6Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.6", append = TRUE)
gc()
write.xlsx2(mergedAnnotationCluster7Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.7", append = TRUE)
gc()
write.xlsx2(mergedAnnotationCluster8Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.8", append = TRUE)
gc()
write.xlsx2(mergedAnnotationCluster9Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.9", append = TRUE)
gc()
write.xlsx2(mergedAnnotationCluster10Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.10", append = TRUE)
gc()
write.xlsx2(mergedAnnotationCluster11Markers, file = sprintf("%s_Cluster markers.xlsx", filePrefix), sheetName = "manC.11", append = TRUE)
gc()
