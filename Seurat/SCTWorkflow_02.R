...
projectName = "pooledPhenotypes_CRCL_SCT_002"
...
manualAnnotation = read_xlsx("/projects/petunia/scRNASeq/annotation/manualAnnotation.xlsx")

# Import the .h5 dataset
rawData = Read10X_h5("/projects/petunia/scRNASeq/pooledPhenotypes/data/filtered_feature_bc_matrix.h5")
